...
var steamAddCmd = &cobra.Command{
	...
	Long: `Creates a .desktop file for Cluckers so it appears in Steam's
"Add a Non-Steam Game" dialog. After running this command, open Steam
and add the game from the dialog.`,
